...
description = "FeatherMorph Core - Yet another disguise plugin, introducing morph features to the server"
...
paper {
    ...
    apiVersion = "1.21"
    authors = listOf("MATRIX-feather", "clre20")
...
tasks.shadowJar {
    ...
    archiveFileName = "feathermorph-${project.property("project_version")}-final.jar"
}
